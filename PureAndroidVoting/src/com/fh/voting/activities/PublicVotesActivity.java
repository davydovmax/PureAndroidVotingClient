...
public class PublicVotesActivity extends DatabaseWrapperActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final PublicVotesActivity voteActivity = this;
	...
	protected void onResume() {
		...
		VoteListAdapter adapter = new VoteListAdapter(this, R.layout.vote_list_item, this.modelManager.getTopVotes());
		this.lstVotes.setAdapter(adapter);
	};

	private void openActivity(Class<?> cls, Bundle bundle) {
		Intent intent = new Intent(PublicVotesActivity.this, cls);
		if (bundle != null) {
